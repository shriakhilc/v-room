...
export default function LocalStreamManager({ setLocalStream, localStream, mutedByHost }: LocalStreamManagerProps) {
    ...
    useEffect(
        ...
        [setLocalStream, playing, localStreamView, toggleLocalAudio, toggleLocalVideo]
    );

    useEffect(
        () => {
            console.log(`mute by host effect triggered`);
            setLocalAudio(false);
            if (localStream !== null) {
                localStream.getAudioTracks().forEach((track) => track.enabled = false);
            }
        },
        [mutedByHost, localStream]
    );
    ...
    return (
        <div className="">
            ...
            <div className="btn-group btn-group-horizontal">
                ...
                <button className={localAudio ? "btn btn-success" : "btn btn-error"} onClick={() => toggleLocalAudio(localStream)}>
                    {localAudio ?
                ...
                <button className={localVideo ? "btn btn-success" : "btn btn-error"} onClick={() => toggleLocalVideo(localStream)}>
                    {localVideo ?
