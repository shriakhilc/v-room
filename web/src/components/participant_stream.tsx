...
export default function ParticipantStream({ call, onKick, isHost }: ParticipantStreamProps) {
        ...
        <>
            <div className="">
                ...
                <div className="btn-group btn-group-horizontal">
                    <button className={remoteAudio ? "btn btn-success" : "btn btn-error"} onClick={() => toggleRemoteAudio(participantStream)}>
                        {remoteAudio ?
                    ...
                    <button className={remoteVideo ? "btn btn-success" : "btn btn-error"} onClick={() => toggleRemoteVideo(participantStream)}>
                        {remoteVideo ?
                    ...
                    {isHost &&
                        <button className="btn btn-error" onClick={onKick}>
                            Kick
                        </button>
                    }
                </div>
